    ...
    <main>
          ...
          <div className="row justify-center">
            <div className="col-lg-8 text-center">
              <div className="banner-content">
                <p className="text-uppercase text-primary font-bold mb-6 tracking-wide max-w-2xl mx-auto leading-relaxed">
                ...
                <h1 className="text-3xl md:text-5xl lg:text-6xl text-uppercase text-primary font-bold leading-tight mb-12">
                  Vos projets sont nos projets,<br />votre réussite est notre réussite
                </h1>

                <div className="flex flex-col items-center mt-8">
                  <div className="chevron-container animate-bounce">
                    <div className="w-6 h-6 border-b-2 border-r-2 border-primary rotate-45 mb-[-12px]"></div>
                    <div className="w-6 h-6 border-b-2 border-r-2 border-primary rotate-45 mb-[-12px]"></div>
                    <div className="w-6 h-6 border-b-2 border-r-2 border-primary rotate-45"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="realisations" className="py-24 md:py-32 bg-cover bg-center bg-fixed relative" style={{ backgroundImage: "url('/img/realisation-bg.jpg')" }}>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-brownred text-5xl mb-16">Réalisations</h1>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 mt-12 overflow-hidden">
            {[1, 2, 3, 4, 5, 9, 7, 10].map((id, index) => (
              <div key={index} className="relative group aspect-square overflow-hidden cursor-pointer">
                {/* This would ideally use project images, mimicking the old ID structure */}
                <Image
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center text-white">
                  <p className="mb-2">Projet</p>
                  <div className="w-12 h-px bg-white mb-2"></div>
                  <h5 className="text-xl uppercase font-bold">{id < 10 ? `0${id}` : id}</h5>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="identite" className="relative py-48 md:py-64 bg-cover bg-fixed" style={{ backgroundImage: "url('/img/identite-bg.jpg')" }}>
        ...
        <div className="container mx-auto px-4 relative z-10 flex justify-center lg:justify-start">
          <div className="max-w-2xl">
            <h1 className="text-brownred text-5xl font-bold mb-10">Identité</h1>
            <div className="space-y-6 text-lg text-brownred font-medium">
              ...
              <p className="pt-4 font-bold">Fort de ces expériences et de ce parcours professionnel, je suis à votre disposition pour tous projets bois ou mixtes bois/métal, n'hésitez pas à me contacter...</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 md:py-32 bg-cover bg-center bg-fixed relative" style={{ backgroundImage: "url('/img/contact-bg.jpg')" }}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl text-white font-bold mb-16 text-center">Contactez-nous</h2>
